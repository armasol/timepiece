...
export default function WatchesPage(){
 ...
 return <main className="page watches-page"><Nav/><section className="section" style={{paddingTop:150}}><div className="container"><div className="kicker">Watch markets</div><h1 className="h2 serif">Browse watch-linked token markets.</h1><p className="lead">Filter by brand, open the watch record, then review its linked market data before connecting a wallet.</p>
